    ...
    <main className="container mx-auto mb-auto">
      <div className="min-h-full flex items-center justify-center py-12 px-6 sm:px-8 lg:px-10">
        <div className="max-w-md dark:shadow dark:bg-tertiary py-8 px-4 sm:py-6 sm:px-6 w-fit flex flex-col gap-6">
          ...
          <form
            className="form-div flex flex-col gap-4"
            onSubmit={handleSubmit(async (data) => {
              if (data.knownLanguageId === data.learnLanguageId) {
                setError('learnLanguageId', {
                  type: 'languages',
                  message:
                    ' Learning language cannot be the same as known language',
                });
                return;
              }
          ...
          >
            <div>
              <label className="label text-sm" htmlFor="username">
                Name
              </label>
              <input
                {...register('username', {
            ...
            <div>
              <label htmlFor="knownLanguageId" className="label text-sm">
                I know
              </label>
              {
                <select
            ...
            <div>
              <label htmlFor="learnLanguageId" className="label text-sm">
                I want to learn
              </label>
              {
                <select
              ...
              {errors.learnLanguageId && (
                <p style={{ color: 'red', fontSize: '14px' }}>
                  {errors.learnLanguageId.message}
                </p>
              )}
            </div>
            ...
            <div>
              <div className="userFields hidden" aria-hidden="true">
                ...
                <input
                  {...register('website')}
                  className="input website hidden"
                  type="text"
                  tabIndex={-1}
                />
              </div>
