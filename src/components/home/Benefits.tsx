          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                <button className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-10 rounded mx-10 my-3"><a href="/login">Sign in</a></button>
                </div>
                <div>
                  {/* <a className="btn text-white bg-gray-900 hover:bg-gray-800
                  w-full sm:w-auto sm:ml-4" href="#0">Sign up</a> */}
                  <button className="bg-gray-900 hover:bg-gray-800 text-white py-2 px-10 rounded mx-10 my-3"><a href="/signup">Sign up</a></button>
                </div>
              </div>
            </div>
          </div>
