            ...
            <div className="py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
              ...
              <div className="lg:mt-0 lg:flex-shrink-0">
                <div className="mt-12 inline-flex rounded-md shadow">
                  <Link to="/texts">
                    <button type="button" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-sky-600 hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
                      Go to texts
                    </button>
                  </Link>
                </div>
          ...
          <div className="bg-secondary text-black overflow-hidden relative lg:flex lg:items-center">
            <div className="py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
              ...
              <div className="text-md mt-4 text-secondary">
                ...
                <p className="pb-2">If you cannot find it, click the link to resend the email.</p>
              </div>
              <div className="lg:mt-0 lg:flex-shrink-0">
                <div className="mt-12 inline-flex rounded-md shadow">
                  { sent === false
                    ? <button type="button" onClick={(event) => { event.preventDefault(); sendMail(); }} className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-sky-600 hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
                        Resend email
                      </button>
                    : <button type="button" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-500">
                        Mail sent
                      </button>
                  }
                </div>
